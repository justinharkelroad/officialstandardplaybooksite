import type { MirrorPillar, MirrorTier } from "../templates/_shared.ts";

const M: Record<MirrorTier, Record<MirrorPillar, string>> = {
  foundation: {
    culture_team:
...
export function getDiagnosticParagraph(tier: MirrorTier, weakestPillar: MirrorPillar): string {
  return M[tier]?.[weakestPillar] ?? "";
}
