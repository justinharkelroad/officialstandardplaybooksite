      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto space-y-4 text-xl text-gray-300">
            ...
            <p className="font-medium text-4xl text-slate-50 text-center">Because accountability without consequences is just expensive friendship.</p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {softwareFeatures.map((feature, index) => <Card key={index} className="bg-dark-card border-primary/20 card-hover overflow-hidden">
