...
import { Target, BookOpen, Video, Users, ArrowRight, Play } from 'lucide-react';
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-12 animate-fade-up" style={{ animationDelay: '0.2s' }}>
            Start your journey with foundational tools and resources designed to elevate your entrepreneurial mindset and business fundamentals.
          </p>
