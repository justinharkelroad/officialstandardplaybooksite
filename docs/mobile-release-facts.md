...
| Android release version | `1.0.3` (`versionCode 4`) |
| Android target | API 35, valid for the initial public submission before Google Play's August 31, 2026 API 36 deadline |
...
| Google Play current track | Internal testing active with `1.0.2 - Internal Beta 3` (`versionCode 3`); Production unlocked but inactive |
